 ...
 */
export const getUserFavoritesController: RequestHandler = async (
  req: Request,
  res: Response
) => {
  try {
 ...
 */
export const toggleUserFavoriteController: RequestHandler = async (
  req,
  res
) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "An error occurred while toggling the favorite item." });
  }
};
 ...
 */
export const getUserRecentlyViewedController: RequestHandler = async (
  req,
  res
) => {
  try {
 ...
 */
export const getUserRequestsController: RequestHandler = async (req, res) => {
  try {
    const userEmail = req.session.user;
